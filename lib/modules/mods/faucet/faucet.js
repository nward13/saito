...
Faucet.prototype.returnFaucetHTML = function returnFaucetHTML(saito_address, source_domain="saito.tech", source_port="", source_protocol="http") {
...
Faucet.prototype.returnFaucetSuccessHTML = function returnFaucetSuccessHTML(source_domain="saito.tech", source_port="", source_protocol="http") {
  var emailUrl
  ...
  if (source_port == ":" && source_domain.indexOf('://') > 0) {
    ...
    emailUrl = `${source_protocol}://${source_domain}/email`
  } else {
    emailUrl = `${source_protocol}://${source_domain}${source_port}/email`
  }
