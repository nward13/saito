...
Faucet.prototype.webServer = function webServer(app, expressapp) {
  ...
  expressapp.get('/faucet/success', function (req, res) {
    ...
    //Change from 24 clock hours to once per calendar day. More intuitive for users.
    var unixtime_check = new Date();
    unixtime_check.setHours(0,0,0,0);
    unixtime_check = unixtime_check.getTime();
