...
Registry.prototype.displayEmailForm = function displayEmailForm(app) {
  ...
  <div id="module_instructions" class="module_instructions">
    Register a human-readable email address:<p></p>
    <input type="text" class="module_textinput" id="module_textinput" value="" autofocus/>
    <div class="module_textinput_details">@${this.domain}</div>
    <p style="clear:both;margin-top:0px;"> </p>ASCII characters only, e.g.: yourname@${this.domain}, etc.
    <p></p><div id="module_textinput_button" class="module_textinput_button" style="margin-left:0px;margin-right:0px;">register</div>
  </div>`;
