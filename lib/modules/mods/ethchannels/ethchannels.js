...
EthChannels.prototype.requestChannelEmail = function requestChannelEmail(tx, app) {
  ...
  + '<div id="open_channel_tx" style="display:none;">'
    ...
    +'This can be done using Geth or Remix. The contract ABI and source code can be found within the contract directory of this module.'
...
//     +'<p id="msg_to_sign"></p>'
//     +'<p>This message is the Solidity Sha3 hash of the channel key and the payment amount (in Wei). '
