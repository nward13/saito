...
Transaction.prototype.returnSignatureSource = function returnSignatureSource(app) {
  return this.fastSerialize(this.transaction.from)
    + this.fastSerialize(this.transaction.to)
    + this.transaction.ts
    + this.transaction.ps
...
Transaction.prototype.fastSerialize = function fastSerialize(obj) {
...
Transaction.prototype.returnMessageHash = function returnMessageHash(app) {
  if (this.transaction.mhash == "") { this.transaction.mhash = app.crypto.hash(this.returnMessageSignatureSource()); }
  return this.transaction.mhash;
}
Transaction.prototype.returnMessageSignatureSource = function returnMessageSignatureSource() {
  return this.fastSerialize(this.transaction.msg+this.transaction.ts);
}
