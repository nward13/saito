...
if (this.transaction.mhash != "") {

  ////////////////////////////
  // validate msg signature //
  ////////////////////////////
  if (!app.crypto.fastVerifyMessage(this.transaction.mhash,this.transaction.msig,this.returnSender())) {
    console.log("transaction message signature does not verify 4");
    return 0;
  }
  ...
  if (!app.crypto.verifyMessage(this.returnMessageSignatureSource(),this.transaction.msig,this.returnSender())) {
    console.log("transaction message signature does not verify 5");
    return 0;
  }
