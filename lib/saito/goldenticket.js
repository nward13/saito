...
//      new_treasury = new_treasury.plus(Big(prevblk.returnTransactionFeesNeededForThisBlock())).toFixed(8);
...
console.log("OLD t&c: " + prev_treasury + " --- " + prev_coinbase);
console.log("NEW t&c: " + new_treasury + " --- " + new_coinbase);
