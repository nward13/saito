...
console.log("calculating with key: " + publickey);

  if (publickey == "") { publickey = this.app.wallet.returnPublicKey(); }

  let v = Big(0);
console.log("HOW MANY TXS TO ADD UP: " + this.transactions.length);
  for (let i = 0; i < this.transactions.length; i++) {
console.log("TX " + i + " -> " + this.transactions[i].returnFeesUsable(this.app, publickey));
