...
console.log("SETTING UTXI_HASHMAP TO 1 for "+hmi);
...
console.log("HASHMAP INDEX: " + hmi);
console.log("VALUE: " + this.utxi_hashmap[hmi]);
...
console.log("not enough money available -- return null");
    return null; 
  }
...
console.log("CON UTXI: " + this.containsUtxi(s));
          if (this.containsUtxi(s) == 0) {
console.log("CON UTXO: " + this.containsUtxo(s));
	    if (this.containsUtxo(s) == 0) {
console.log("ADDING UTXI");
	      this.addUTXI(s);
            }
          }
        }
