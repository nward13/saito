...
console.log(" .... update slips: " + new Date().getTime());
...
console.log(" .... update shshmp: " + new Date().getTime());
...
console.log(" .... update blkdb: " + new Date().getTime());
...
console.log(" .... save to disk: " + new Date().getTime());
