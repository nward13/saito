...
console.log(" .... at start:    " + new Date().getTime() + " w/txs " + newblock.transactions.length);
...
console.log(" .... start suc:   " + new Date().getTime() + " w/txs "+newblock.transactions.length);
  //
  // update newblock
  //
  ...
  // the wallet update.
  //
console.log(" .... pre saveb:   " + new Date().getTime() + " w/txs "+newblock.transactions.length);
  await this.app.storage.saveBlock(newblock, i_am_the_longest_chain);
console.log(" .... post saveb:  " + new Date().getTime() + " w/txs "+newblock.transactions.length);
  await this.saveBlockchain();
console.log(" .... pre wallt:   " + new Date().getTime() + " w/txs "+newblock.transactions.length);
...
console.log(" .... post walt:   " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
...
console.log(" .... blocksync:   " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
...
console.log(" .... pre callbks: " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
  //
...
console.log(" .... onNewblk:    " + new Date().getTime());
  ...
  this.indexing_active = false;
console.log(" ... done:       " + new Date().getTime()  + " w/txs "+newblock.transactions.length);
console.log("\n");
  return 1;
