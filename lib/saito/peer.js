	...
	if (this.app.BROWSER == 1) {
	  ...
	  if (this.app.options.peers != undefined) {
	    for (let i = 0; i < this.app.options.peers.length; i++) {
	      if (
	        this.app.options.peers[i].peer.host == this.peer.host &&
	        this.app.options.peers[i].peer.port == this.peer.port
	      ) {
...
console.log("\n\n\nINBOUND CONNECTION: ");
console.log(last_shared_bid + " --- " + peer_last_bid);
console.log("\n\n");
...
console.log("WE NEED TO UPDATE THEIR GENESIS BLOCK!");
