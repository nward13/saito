...
console.log("send request "+message+" to: " + this.peer.host);
...
this.app.logger.logInfo("send request 1-2 to " + this.peer.host + " " + JSON.stringify(userMessage));
  ...
  // never connect.
  //
console.log("sending rqst "+message+" to: " + this.peer.publickey);
  if (this.socket != null) {
    if (this.socket.connected == true) {
      this.socket.emit('request',JSON.stringify(userMessage));
    } else {
...
console.log("send request "+message+" 2: " + this.peer.publickey);
...
console.log("sending rqst "+message+" 2: " + this.peer.publickey);
