...
this.app.logger.logInfo("send request 1-2 to " + this.peer.host + " " + JSON.stringify(userMessage));
  ...
  // never connect.
  //
console.log("sending rqst "+message+" to: " + this.peer.host);
  if (this.socket != null) {
    if (this.socket.connected == true) {
      this.socket.emit('request',JSON.stringify(userMessage));
    } else {
...
this.app.logger.logInfo("send request 2-1 to " + this.peer.host + " " + JSON.stringify(userMessage));
console.log("send request "+message+" 2: " + this.peer.host);
...
this.app.logger.logInfo("send request 2-2 to " + this.peer.host + " " + JSON.stringify(userMessage));
console.log("sending rqst "+message+" 2: " + this.peer.host);
...
this.app.logger.logInfo("updating peer reliability to " + value + " for peer " + this.peer.host + " and value " + feature);
