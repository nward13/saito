...
function Peer(app, peerjson="") {
  ...
  if (peerjson != "") {
    ...
    if (peerobj.endpoint == null) {
      peerobj.endpoint      = {};
      peerobj.endpoint.host = peerobj.host;
      peerobj.endpoint.port = peerobj.port;
      peerobj.endpoint.protocol = peerobj.protocol;
    }

    this.peer = Object.assign(this.peer, peerobj);
  }
